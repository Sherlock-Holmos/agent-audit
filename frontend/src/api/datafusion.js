...
export const updateFusionTask = (id, payload) => client.patch(`/data/fusion/tasks/${id}`, payload)
export const runFusionTask = (id) => client.post(`/data/fusion/tasks/${id}/run`)
export const getFusionTaskPreview = (id, params) => client.get(`/data/fusion/tasks/${id}/preview`, { params })
